...
static const char *tray[] = { "/home/chris/myscripts/tray-toggle.sh", NULL };
static const char *rofi[] = { "/usr/bin/rofi", "-modi", "drun", "-show", "drun", "-show-icons", "-theme", "arc-dark", "-font", "hack 20", NULL};
